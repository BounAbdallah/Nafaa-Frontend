    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {packs.map((pack) => (
            <div key={pack.id} className="card group hover:border-primary-300 transition-all overflow-hidden flex flex-col">
              {/* Pack Header */}
              <div className="p-6 border-b border-muted-100 relative">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-1">
                    <Link to={`/admin/packs/${pack.id}`} className="p-2 hover:bg-muted-100 rounded-btn transition-colors text-muted-400 hover:text-primary-500">
                      <Edit2 size={16} />
                    </Link>
                    <button 
                ...
                <div className="flex items-baseline gap-1 mt-1">
                  <span className="text-2xl font-display font-black text-navy">{Number(pack.price).toLocaleString()}</span>
                  <span className="text-xs font-sans text-muted-500 font-bold uppercase tracking-widest">FCFA / mois</span>
                </div>
              </div>

              {/* Pack Limits */}
              <div className="p-6 flex-1 space-y-4 bg-muted-50/30">
                <div className="flex items-center gap-3">
                  <Users size={16} className="text-muted-400" />
                ...
                <div className="flex items-center gap-3">
                  <Box size={16} className="text-muted-400" />
                  <div className="flex-1">
                ...
                <div className="flex items-center gap-3">
                  <HardDrive size={16} className="text-muted-400" />
                  <div className="flex-1">
              ...
              <div className="p-4 bg-white border-t border-muted-100 flex items-center justify-between">
                ...
                <Link to={`/admin/packs/${pack.id}`} className="text-xs font-bold text-primary-500 hover:underline flex items-center gap-1">
